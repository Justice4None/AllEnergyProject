...
class Level1 extends Level {
    constructor(game) {
        super(game, 1)
        this.game.canvas.canDiv.style.backgroundImage = "url('resources/resources/images/bg/start.png')"
...
class Level2 extends Level {
    constructor(game) {
        super(game, 2)
        this.game.canvas.canDiv.style.backgroundImage = "url('resources/resources/images/bg/play.png')"
        ...
        this.game.backgroundMusic = new Audio('resources/resources/sounds/Elevator-music.mp3')
        this.game.loadGrid();
...
class Level3 extends Level {
    constructor(game) {
        super(game)
        this.game.enemies = []
        this.game.canvas.canDiv.style.backgroundImage = "url('resources/resources/images/bg/end.png')"
